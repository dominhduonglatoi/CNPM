...
namespace QLBANHOA
{
    public partial class frm_DE_PGiao : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void frm_DE_PGiao_Load(object sender, EventArgs e)
        {
            init();
            getData();
            btn_DE_delPG.Enabled = false;
        }
        ...
        private void btn_DE_savePG_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            String tt = "Chưa Giao";
            if (flag)
            {
...

                {
                    var h = new PHIEUDAT
                    {
                        ...
                        NGAYGIAO = this.txt_NgayGiao.Value.Date,
            ...
            else
            {
                if (MessageBox.Show("Bạn có muốn sửa thông tin  không ?", "Thông báo", MessageBoxButtons.YesNo, MessageBoxIcon.Warning) == DialogResult.Yes)
                {
                    ...
                    else
                    {
                        ...
                        phieuhang.NGAYGIAO = this.txt_NgayGiao.Value.Date;
        ...
        private void dg_phieuhang_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex >= 0)
            {
                ...
                btn_DE_delPG.Enabled = true;
            }
        }

        private void btn_DE_delPG_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
        ...
        private void btn_DE_cancelPG_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            txtTenNN.Text = "";
            txtSoPhieu.Text = "";
            txtDiaChiNguoiNhan.Text = "";
